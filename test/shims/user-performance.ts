(function (global) {
  var
    ...
    , performance: any = (global as any).performance || {}
  ...
  if (typeof (global as any).define === "function" && ((global as any).define.amd || (global as any).define.ajs)) {
    (global as any).define("performance", [], function () { return performance });
  }
})(global);
