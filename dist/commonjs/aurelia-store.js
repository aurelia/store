                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (this.options.logDispatchedActions) {
                            this.logger[getLogType(this.options, "dispatchedActions", exports.LogLevel.info)]("Dispatching: ".concat(callingAction.name));
                        }
                    ...
                    case 6:
                        ...
                        if (this.options.measurePerformance === exports.PerformanceMeasurement.StartEnd) {
                            ...
                            this.logger[getLogType(this.options, "performanceLog", exports.LogLevel.info)]("Total duration ".concat(measures[0].duration, " of dispatched action ").concat(callingAction.name, ":"), measures);
                        }
                            ...
                            this.logger[getLogType(this.options, "performanceLog", exports.LogLevel.info)]("Total duration ".concat(totalDuration, " of dispatched action ").concat(callingAction.name, ":"), marks);
                        }
                        this.clearMarks();
                        this.clearMeasures();
    ...
    Store.prototype.setupDevTools = function () {
        ...
        if (aureliaPal.PLATFORM.global.__REDUX_DEVTOOLS_EXTENSION__) {
            ...
            this.devTools.subscribe(function (message) {
                _this.logger[getLogType(_this.options, "devToolsStatus", exports.LogLevel.debug)]("DevTools sent change ".concat(message.type));
